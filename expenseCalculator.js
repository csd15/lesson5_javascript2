        ...
        if (status == 0) { 
          ...
          *******************************************************************************/
             ...
             if (income <= 18550){
                 ...
                 tax = 18550 * 0.10 + (75300 - 18550) * 0.15 +
                       (151900 - 73500) * 0.25 + (income - 151900) * 0.28;
                 taxRate = 28;
               }//end of else if
               else if (income <= 413350) {
                 tax = 18550 * 0.10 + (75300 - 18550) * 0.15 +
                 ...
                 taxRate = 33;
                  ...
                  tax = 18550 * 0.10 + (75300 - 18850) * 0.15 +
                        (151900 - 75300) * 0.25 + (231450 - 151900) * 0.28 +
          ...
          *******************************************************************************/
                ...
                if (income <= 9275){
                 ...
                 taxRate = 33;
                  ...
                  tax = 9275 * 0.10 + (37650 - 9275) * 0.15 +
                        (75950 - 37650) * 0.25 + (115725 - 75950) * 0.28 +
                        (206675 - 231450) * 0.33 + (233475 - 206675 ) * 0.35 + (income - 233475) * .396;
                  taxRate = 39.6;
               }//end of nested if
          }//end of married file seperately calculation
          ...
          *******************************************************************************/
                ...
                if (income <= 13250){
                 ...
                 tax = 1325 * 0.10 + (50400 - 13250) * 0.15 + (income - 50400) * 0.25;
                 taxRate = 25;
               } //end of else if
               else if (income <= 210800) {
                 tax = 1325 * 0.10 + (50400 - 13250) * 0.15 +
